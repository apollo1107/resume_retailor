 ...
 * SPARKLE_PROFILE_CSS: profile + manual profile (main form, top hover dock, left email rail).
 */
...
export const SPARKLE_PROFILE_CSS = `
  ...
  /* Left rail: email snippet topics from /email-snippets.json (hover or pin to keep open) */
  .rt-left-email-dock {
    position: fixed;
    left: 0;
    top: 0;
  ...
  .rt-left-email-dock__hit {
    width: 18px;
    flex-shrink: 0;
    align-self: stretch;
    pointer-events: auto;
  }
  .rt-left-email-dock__panel {
    display: flex;
    flex-direction: column;
    min-width: 0;
    max-width: 0;
    ...
    box-shadow: none;
    transition:
      max-width 0.48s cubic-bezier(0.22, 1, 0.32, 1),
      min-width 0.48s cubic-bezier(0.22, 1, 0.32, 1),
      opacity 0.34s cubic-bezier(0.22, 1, 0.55, 1),
      transform 0.45s cubic-bezier(0.34, 1.45, 0.52, 1),
      padding 0.4s ease,
      background 0.3s ease,
      border-color 0.3s ease,
      box-shadow 0.4s ease;
  }
  .rt-left-email-dock:hover .rt-left-email-dock__panel,
  .rt-left-email-dock--pinned .rt-left-email-dock__panel {
  ...
  .rt-left-email-dock__pin:hover,
  .rt-left-email-dock__pin:focus-visible {
    transform: scale(1.06);
    background: rgba(255, 255, 255, 0.42);
    border-color: rgba(255, 255, 255, 0.58);
    outline: none;
  }
  .rt-left-email-dock__pin--active {
    background: rgba(34, 211, 238, 0.35);
    border-color: rgba(6, 182, 212, 0.65);
    box-shadow:
      0 0 0 1px rgba(34, 211, 238, 0.25) inset,
  ...
  .rt-left-email-dock__pin--active:hover,
  .rt-left-email-dock__pin--active:focus-visible {
    background: rgba(34, 211, 238, 0.48);
    border-color: rgba(8, 145, 178, 0.75);
  }
  .rt-left-email-dock__error {
    margin: 0 0 8px;
    padding: 0;
    font-size: 11px;
    line-height: 1.35;
  ...
  .rt-left-email-dock__topic:hover,
  .rt-left-email-dock__topic:focus-visible {
    ...
    text-shadow:
      0 0 16px rgba(165, 243, 252, 0.65),
      0 1px 2px rgba(15, 23, 42, 0.9);
  }
  .rt-left-email-dock__topic--copied {
    background: rgba(6, 78, 59, 0.65);
    border-color: rgba(52, 211, 153, 0.8);
    color: #d1fae5;
    text-shadow:
      0 0 14px rgba(167, 243, 208, 0.55),
      0 1px 2px rgba(15, 23, 42, 0.85);
    box-shadow:
  ...
  @media (hover: none) {
    ...
    .rt-left-email-dock .rt-left-email-dock__panel {
